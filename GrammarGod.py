...
textIN = Text(mainFrame, bd=2, font=("Helvetica", 10), height=5, width=50,
              wrap=WORD)
textIN.pack()

submitButton = Button(mainFrame, padx=4, pady=4, bd=2, text="Fix Text!",
                      justify=RIGHT, command=lambda: readText())
submitButton.pack()

Label(mainFrame, bd=2, text="Corrected text is shown below:").pack()
textOUT = Text(mainFrame, bd=4, font=("Helvetica", 10), height=5, width=50,
               wrap=WORD)
textOUT.pack()
